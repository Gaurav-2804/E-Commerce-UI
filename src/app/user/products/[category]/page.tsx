...
const ProductswithCategoryPage = (query: any) => {
    ...
    const fillterProductByTypes = (productListArray: ProductObject[], selectedTypes: string[]) => {
        ...
        console.log('check currenttpelist', currentTypeList, selectedTypes);
    ...
    useEffect(() => {
        console.log('catType', categoryType);
        if(categoryType){
    ...
    const handleSelectedType = (type: string, idx:number) => {
        if(filteredProductList) {
            ...
            if(filterProductBySelectedType.length > 0) {
                ...
                console.log("idx",idx, filteredProductList);
            }
            else{          
                setSelectedTypes([]);
            }
            ...
            router.push(`/user/products/${categoryType?.selectedCategoryObject?.key.replaceAll(' ','')}?${queryString}`);
        }
    }
            ...
            <div className={((isLoading)?"blur-sm ":"") + "mx-auto w-2/3 bg-slate-50"}>
                <div className="p-4 min-h-screen">
                    ...
                    <div className="flex">
                        ...
                        <div className="w-3/4 flex border-l border-l-slate-400">
                            {
...
export default ProductswithCategoryPage;